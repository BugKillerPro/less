...
// NewlessSSH 代表实例化Client
func NewlessSSH(params ...interface{}) (interface{}, error) {
...
func (app *lessSSH) GetClient(option ...contract.SSHOption) (*ssh.Client, error) {
