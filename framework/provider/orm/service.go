...
// lessGorm 代表less框架的orm实现
type lessGorm struct {
...
func NewlessGorm(params ...interface{}) (interface{}, error) {
...
// GetDB 获取DB实例
func (app *lessGorm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
