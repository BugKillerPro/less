...
// lessRotateLog 代表会进行切割的日志文件存储
type lessRotateLog struct {
	lessLog
...
// NewlessRotateLog 实例化lessRotateLog
func NewlessRotateLog(params ...interface{}) (interface{}, error) {
	// 参数解析
	...
	// 从配置文件中获取file信息，否则使用默认的less.log
	file := "less.log"
