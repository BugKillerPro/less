...
// AppID 表示这个App的唯一ID
func (app lessApp) AppID() string {
	return app.appId
}

// Version 实现版本
func (app lessApp) Version() string {
	return "0.0.3"
}

// BaseFolder 表示基础目录，可以代表开发场景的目录，也可以代表运行时候的目录
func (app lessApp) BaseFolder() string {
	if app.baseFolder != "" {
...
func (app lessApp) ConfigFolder() string {
...
// LogFolder 表示日志存放地址
func (app lessApp) LogFolder() string {
...
func (app lessApp) HttpFolder() string {
...
func (app lessApp) ConsoleFolder() string {
...
func (app lessApp) StorageFolder() string {
...
func (app lessApp) ProviderFolder() string {
...
func (app lessApp) MiddlewareFolder() string {
...
func (app lessApp) CommandFolder() string {
...
func (app lessApp) RuntimeFolder() string {
...
func (app lessApp) TestFolder() string {
...
func (app lessApp) DeployFolder() string {
...
func NewlessApp(params ...interface{}) (interface{}, error) {
	...
	return &lessApp{baseFolder: baseFolder, container: container, appId: appId, configMap: configMap}, nil
}

// LoadAppConfig 加载配置map
func (app *lessApp) LoadAppConfig(kv map[string]string) {
...
// AppFolder 代表app目录
func (app *lessApp) AppFolder() string {
