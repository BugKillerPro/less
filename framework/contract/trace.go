...
type Trace interface {
	// // SetTraceIDService set TraceID generator, default lessIDGenerator
	// SetTraceIDService(IDService)
	// // SetTraceIDService set SpanID generator, default lessIDGenerator
