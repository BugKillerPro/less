...
import (
	...
	testdata "github.com/BugKillerPro/less/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/BugKillerPro/less/framework/gin.handlerNameTest$", c.HandlerName())
}
